...
for i in range(6):
    current_match_title = match_titles[i]
    current_match_score = match_scores[i]

    update_points(current_match_title, current_match_score)
    update_wlds(current_match_title, current_match_score)
    update_goal_diff(current_match_title, current_match_score)
